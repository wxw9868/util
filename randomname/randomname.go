...
// 随机昵称 形容词
var niChengTou = []string{"迷你的", "鲜艳的", "飞快的", "真实的", "清新的", "幸福的", "可耐的", "快乐的", "冷静的", "醉熏的", "潇洒的", "糊涂的", "积极的", "冷酷的", "深情的", "粗暴的",
	...
	"还单身的", "怕孤单的", "懵懂的"}
var niChengWei = []string{"嚓茶", "皮皮虾", "皮卡丘", "马里奥", "小霸王", "凉面", "便当", "毛豆", "花生", "可乐", "灯泡", "哈密瓜", "野狼", "背包", "眼神", "缘分", "雪碧", "人生", "牛排",
...
// 百家姓
var arrXing = []string{"赵", "钱", "孙", "李", "周", "吴", "郑", "王", "冯", "陈", "褚", "卫", "蒋", "沈", "韩", "杨", "朱", "秦", "尤", "许", "何", "吕", "施", "张", "孔", "曹", "严", "华", "金", "魏", "陶", "姜", "戚", "谢", "邹",
...
// 名
var arrMing = []string{"伟", "刚", "勇", "毅", "俊", "峰", "强", "军", "平", "保", "东", "文", "辉", "力", "明", "永", "健", "世", "广", "志", "义", "兴", "良", "海", "山", "仁", "波", "宁", "贵", "福", "生", "龙", "元", "全",
...
// GenerateName 生成随机昵称 1生成昵称，2生成姓名
// 汉语 - 给用户自动生成昵称
func GenerateName(nameType int) string {
	var niCheng string
	switch nameType {
	case 1:
		touNum := rand.Intn(len(niChengTou) - 1)
		weiNum := rand.Intn(len(niChengWei) - 1)
		niCheng = niChengTou[touNum] + niChengWei[weiNum]
	case 2:
		niCheng = arrXing[rand.Intn(len(arrXing)-1)]
		for i := 0; i < 2; i++ {
			if rand.Intn(2) == 1 {
				niCheng += arrMing[rand.Intn(len(arrMing)-1)]
			} else {
				niCheng += arrMing[rand.Intn(len(arrMing)-1)]
			}
		}
